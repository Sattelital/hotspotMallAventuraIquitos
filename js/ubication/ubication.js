...
const PROVINCIAS = {
    ...
    "3884": [
        ...
        {
            "id_ubigeo": "3906",
            "nombre_ubigeo": "Ferreñafe",
            "codigo_ubigeo": "02",
            "etiqueta_ubigeo": "Ferreñafe, Lambayeque",
            "buscador_ubigeo": "ferreñafe lambayeque",
            "numero_hijos_ubigeo": "6",
            "nivel_ubigeo": "2",
            "id_padre_ubigeo": "3884"
        },
    ...
    "3906": [
        {
            ...
            "codigo_ubigeo": "02",
            "etiqueta_ubigeo": "Caqaris, Ferreñafe",
            "buscador_ubigeo": "caqaris ferreñafe",
            "numero_hijos_ubigeo": "0",
            "nivel_ubigeo": "3",
        ...
        },
        {
            ...
            "nombre_ubigeo": "Ferreñafe",
            "codigo_ubigeo": "01",
            "etiqueta_ubigeo": "Ferreñafe, Ferreñafe",
            "buscador_ubigeo": "ferreñafe ferreñafe",
            "numero_hijos_ubigeo": "0",
            "nivel_ubigeo": "3",
            "id_padre_ubigeo": "3906"
        },
        {
            ...
            "codigo_ubigeo": "03",
            "etiqueta_ubigeo": "Incahuasi, Ferreñafe",
            "buscador_ubigeo": "incahuasi ferreñafe",
            "numero_hijos_ubigeo": "0",
            "nivel_ubigeo": "3",
            "id_padre_ubigeo": "3906"
        },
        {
            ...
            "codigo_ubigeo": "04",
            "etiqueta_ubigeo": "Manuel Antonio Mesones Muro, Ferreñafe",
            "buscador_ubigeo": "manuel antonio mesones muro ferreñafe",
            "numero_hijos_ubigeo": "0",
            "nivel_ubigeo": "3",
            "id_padre_ubigeo": "3906"
        },
        {
            ...
            "codigo_ubigeo": "05",
            "etiqueta_ubigeo": "Pitipo, Ferreñafe",
            "buscador_ubigeo": "pitipo ferreñafe",
            "numero_hijos_ubigeo": "0",
            "nivel_ubigeo": "3",
            "id_padre_ubigeo": "3906"
        },
        {
            ...
            "nombre_ubigeo": "Pueblo Nuevo",
            "codigo_ubigeo": "06",
            "etiqueta_ubigeo": "Pueblo Nuevo, Ferreñafe",
            "buscador_ubigeo": "pueblo nuevo ferreñafe",
            "numero_hijos_ubigeo": "0",
            "nivel_ubigeo": "3",
            "id_padre_ubigeo": "3906"
        }
...
function loadDepartamentos() {
    let htmlDep = '<option value="" selected disabled>Departamento</option>'
    DEPARTAMENTOS.forEach(dep => {
        htmlDep += `<option value="${dep.id_ubigeo}">${dep.nombre_ubigeo}</option>`
    })

    return htmlDep
}

function loadProvincias(dept) {
    let htmlProv = '<option value="" selected disabled>Provincia</option>'
    PROVINCIAS[dept].forEach(prov => {
        htmlProv += `<option value="${prov.id_ubigeo}">${prov.nombre_ubigeo}</option>`
    })
    return htmlProv
}

function loadDistritos(prov) {
    let htmlDist = '<option value="" selected disabled>Distrito</option>'
    DISTRITOS[prov].forEach(dist => {
        htmlDist += `<option value="${dist.id_ubigeo}">${dist.nombre_ubigeo}</option>`
    })
    return htmlDist
}

const btnDepts = document.querySelector('#dept')
const btnProvs = document.querySelector('#prov')
const btnDists = document.querySelector('#dist')
btnDepts.innerHTML = loadDepartamentos()

btnDepts.addEventListener("change", function () {
    btnProvs.innerHTML = loadProvincias(btnDepts.value)
    btnDists.innerHTML = '<option value="default" selected disabled>Distrito</option>'
});
btnProvs.addEventListener("change", function () {
    btnDists.innerHTML = loadDistritos(btnProvs.value)
});

    // Seleccionar por defecto el deoartamento de Loreto
    // btnProvs.innerHTML = loadProvincias('4108')